...
export default function Navbar() {
  ...
  return (
    <nav className={`navbar transition-all duration-300 ${scrolled ? 'py-2 shadow-lg' : 'py-4'}`}>
      <div className="container mx-auto flex items-center justify-between px-4">
        ...
        {/* Mobile Menu Button */}
        <button
          className="flex md:hidden text-gray-600 focus:outline-none"
      ...
      {mobileMenuOpen && (
        <div className="md:hidden bg-bg-dark border-t border-border py-4">
